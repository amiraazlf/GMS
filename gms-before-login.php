  ...
  <body>
    <nav>
      ...
      <ul class="navbar">
        ...
        <li><a href="#joinevent"> Join Event</a></li>
      </ul>

      <div class="search-bar">
          <input type="text" placeholder="Search Hotel or Restaurant" />
          <a href="#" id="search"><i data-feather="search"></i></a>
      </div>

      <div class="account">
        <a class="log" href="login.php?form=login">Sign In</a>
        <a class="reg" href="login.php?form=signup">Sign Up</a>
      </div>
    </nav>
    ...
    <div class="section-header">
      ...
      <a href="detail-loc.php" class="view-all">View all</a>
    </div>
    ...
    <section>
      <div class="sec">
        <img
          src="https://images.squarespace-cdn.com/content/v1/6493a716f6221e0b376dbc40/58926afc-d4a0-45b6-b92f-72a535666292/WEDDING+-+DAVID+NIDYA+-+143.jpg"
        />
